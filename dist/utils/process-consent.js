...
const _1 = require(".");
const processConsent = (resp_1, _a, ...args_1) => __awaiter(void 0, [resp_1, _a, ...args_1], void 0, function* (resp, { action, authToken, userId, }, options = { redirect: true }) {
    ...
    if (options.redirect) {
        return _1.Navigation.backTo(resp, authenticationResult, authToken["redirect_uri"]);
    }
    else {
        const response = authenticationResult.value;
        return {
            url: _1.Navigation.buildUrl(authToken["redirect_uri"], response.query, response.fragment),
        };
    }
});
