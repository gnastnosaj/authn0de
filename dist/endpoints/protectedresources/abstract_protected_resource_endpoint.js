    ...
    get endpoint() {
        return functions.https.onRequest((req, resp) => __awaiter(this, void 0, void 0, function* () {
            ...
            protectedResourceEndpoint.accessTokenFetcherProvider =
                new oauth2_nodejs_1.DefaultAccessTokenFetcherProvider();
            protectedResourceEndpoint.dataHandlerFactory =
                new data_1.CloudFirestoreDataHandlerFactory();
            ...
            if (result.isSuccess()) {
                ...
                if (this.validateScope(endpointInfo.scope.split(" "))) {
                    ...
                    try {
                        ...
                        utils_1.Navigation.sendError(resp, new oauth2_nodejs_1.UnknownError(error.toString()));
                    }
                }
                else {
